 ...
 * 已批改列表
 */
class UserHasCorrectAction extends ApiBaseAction
{
    public function run()
    {
        $redis = Yii::$app->cache;
        ...
        $correctids=CorrectService::getUserCorrectidsByStatus($this->_uid,1,$lastid,$rn);
        ...
        $data['total_count']=CorrectService::getUserCorrectCount($submituid);
        $this->controller->renderJson(ReturnCodeEnum::STATUS_OK,$data);
    }
}
