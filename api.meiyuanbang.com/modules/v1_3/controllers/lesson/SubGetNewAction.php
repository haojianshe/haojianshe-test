 ...
 *
 */
class SubGetNewAction extends ApiBaseAction
{
	public function run()
    {
    	//每页返回记录个数
    	...
    	$ret['lessonlist'] = []; 	
    	//(1)根据类型获取id列表
    	$ids = LessonService::getIdsByPage($maintypeid, $subtypeid, 0, $rn);
    	//(2)添加第一张图片
    	...
    	//(3)添加分类型信息
    	$ret['subtypelist']=DictdataService::getLessonSubType($maintypeid);
