 ...
 * @property integer $signup_limit
 * @property string $teacher_id
 * @property integer $rank_status
 */
class MybLk extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ctime', 'btime', 'etime', 'adminid', 'provinceid', 'status', 'newsid', 'start_time', 'end_time', 'signup_limit', 'teacher_id', 'rank_status'], 'integer'],
