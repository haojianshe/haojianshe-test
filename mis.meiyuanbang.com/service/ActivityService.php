...
{    
	//活动列表id 缓存
	private  $activity_list_rediskey = 'activity_newsids';
	//活动详情缓存 activity_detail_ +newsid
	private  $activity_detail_rediskey = 'activity_detail_';
    ...
    public static function getByPage(){
        ...
        ->innerJoin('myb_news_data as d','d.newsid=b.newsid')  
    	->where(['a.status' => 0])
    	->offset($pages->offset)
    	->limit($pages->limit)
