...
<tr><td>连接地址</td><td><input class="inputclass1" name="MisXingePushService[url_params]"  style='width:200px' type='text' value="<?= $model->url_params?>" datatype="url" errormsg="请检查连接地址是否为url地址" sucmsg="&nbsp;"/></td></tr>
