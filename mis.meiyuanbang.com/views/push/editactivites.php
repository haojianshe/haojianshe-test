  ...
  <div class="normaltable">
   <?php $form = ActiveForm::begin(['id' => 'activities']); ?>    
   <table>
    <tbody>     
...
<tr><td>活动id</td><td><input class="inputclass1" name="MisXingePushService[url_params_id]"  style='width:200px' type='text' value="<?= $model->url_params?>" datatype="*1-300" nullmsg="活动id必须输入" sucmsg="&nbsp;"/></td></tr>
<tr><td>活动连接</td><td><input class="inputclass1" name="MisXingePushService[url_params_url]"  style='width:200px' type='text' value="<?= $model->url_params?>"  datatype="url" errormsg="请检查连接地址是否为url地址" sucmsg="&nbsp;"/></td></tr>
