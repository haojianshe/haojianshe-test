  ...
  <div class="normaltable">
   ...
   <table>
    ...
    <tr><td style="width: 100px">标题</td><td style="width: 700px"><input class="inputclass1" name="MisXingePushService[title]"  style='width:200px' type='text' value="<?= $model->title?>" datatype="*1-30" nullmsg="请输入文章标题，最多30个字！" sucmsg="&nbsp;"/></td></tr>
...
<tr><td>文章地址</td><td><input class="inputclass1" name="MisXingePushService[url_params]"  style='width:200px' type='text' datatype="url" errormsg="请检查报名地址是否为url地址" value="<?= $model->url_params?>"/></td></tr>
