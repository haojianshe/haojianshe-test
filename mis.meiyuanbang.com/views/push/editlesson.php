...
<tr><td>考点编号</td><td><input class="inputclass1" name="MisXingePushService[url_params]"  style='width:200px' type='text' value="<?= $model->url_params?>" datatype="*1-300" nullmsg="考点id必须输入" sucmsg="&nbsp;"/></td></tr>
