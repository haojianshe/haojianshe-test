  ...
  <table cellspacing="0" cellpadding="0" class="content_list">
    <thead>
      <tr class="operate">
        ...
        <th colspan="3" style='text-align:right;'>
          <input type="button" onclick="addedit(0);" id="btnnew" value="新建广告主" class="button"/>
        </th>
      </tr>
      <tr class="tb_header">
        <th>编号</th>
    ...
    <? foreach ($models as $model) { ?>
      <tr class="tb_list">
        ...
        <td width="250px">
          <a name='aedit' advuid='<?= $model['advuid'] ?>' href='javascript:;'>编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;
          <a  href='/adv/list?advuid=<?= $model['advuid'] ?>'>广告管理</a>&nbsp;&nbsp;&nbsp;&nbsp;
          <a name='upadtestatus' onclick="upadtestatus(<?= $model['advuid'] ?>);" href='javascript:;'>删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
      </tr>
    <?}?>
    <tr class="operate">
