 ...
 <form id="cmsform" action="/live/ccthumbupload" method="post" role="form" enctype="multipart/form-data">
 <table>
 	<tbody>
  ...
  <script>
        ...
        //保存成功后更新父页面的对应图片，自动关闭
   		...
   		parent.$("#imgthumb11").attr("src",newurl+'?d='+ Date.parse(new Date()));
       		parent.$('#thumb11').val(newurl);
       		parent.layer.close(index);
	   	<? }?>
	   	<?if(isset($msg) && $msg<>''){ ?>
