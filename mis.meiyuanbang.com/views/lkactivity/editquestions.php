...
<div class="normaltable">
    ...
    <table style='width:100%;'>
        ...
        <tr>
            <td style="width: 20%">归属<span class='need'>*</span></td>
            <td>
         ...
         <tr>
            <td style="width: 20%">提问上限</td>
            <td>
                <input class="inputclass1" name="ask_limit" style="width:10%" type="text" value="<?= $model['ask_limit'] ?>"  datatype="/^-?[1-9]\d*$/" nullmsg="报名上限不能为空" errormsg="必须为数字" sucmsg="&nbsp;"/>
            </td>
        </tr>
           <tr>
            <td style="width: 20%">答题人<span class='need'>*</span></td>
            <td>
                <input class="inputclass1" name="answer_uids" style="width:30%" type="text" value="<?= $model['answer_uids'] ?>" nullmsg="答题人不能为空"  sucmsg="&nbsp;"/>&nbsp;多答题人之间用“，”隔开
            </td>
        </tr>
         <tr>
            ...
            <td>
                ...
                <select style="height:30px;" id="cover_type" name="cover_type" class="valid" value="">
                    <option value="1" <?php if($model['cover_type']==1){echo "selected=seleced";}?> >无图样式</option>
                    <option value="2" <?php if($model['cover_type']==2){echo "selected=seleced";}?>>通栏样式</option>
                    <option value="3" <?php if($model['cover_type']==3){echo "selected=seleced";}?>>左图样式</option>
                    <option value="4" <?php if($model['cover_type']==4){echo "selected=seleced";}?>>三图样式</option>
                </select>
            </td>
        </tr>
        <script>
        ...
        <tr id="one" 
        	...
        	<a name='athumb' id='athumb0' thumbid='0' href='#'><img id='img0'
               src="<?php 
               if($model['img']){
               if($model['img'][0]['img']){
        ...
        <tr>
            ...
            <td>
                <input class="inputclass1" name="desc" style="width:90%" type="text" value="<?= $model['desc'] ?>" sucmsg="&nbsp;"/>
            </td>
        </tr> 
          <tr>
