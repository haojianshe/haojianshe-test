        ...
        <tr >
            <th colspan="13" >
                <div class="button-group" >
                    <a href="/reward/prizegame" class="button button-primary  button-small ">抽奖管理</a>
                    <a href="/reward" class="button  button-small">奖品列表</a>
    ...
    <?php foreach ($models as $model) { ?>
        <tr class="tb_list">
            ...
            <td><?php
                ...
                ?> </td>
            <td>
                <a name='show' newsid='<?= $model['gameid'] ?>' href='#'>预览</a>&nbsp;&nbsp;&nbsp;&nbsp;
