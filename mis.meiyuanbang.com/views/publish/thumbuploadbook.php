 ...
 <form id="cmsform" action="/publish/thumbuploadbook" method="post" role="form" enctype="multipart/form-data">
 <table>
 	<tbody>
  ...
  <script>
//     var v =  document.getElementById('layui-layer-iframe1').contentWindow.document.body;
//     alert(v);
  		//父窗口句柄
