...
<!--            <a href="/posid/correct" class="button  button-small  ">改画顶部广告</a>
            <a href="/posid/material" class="button button-small">专题顶部广告</a>
            <a href="/posid/index" class="button button-small  button-primary ">精讲顶部广告</a>-->
  <a href='/posid/index?channelid=<?=$channelid?>' class="button button-small  button-primary ">
<? switch (intval($channelid)) {
  case 1:
   echo "精讲顶部广告";
    break;
   case 5:
...
function addedit(posidid){
  var content = '/posid/edit?channelid=<?=$channelid?>';
  var title = '添加推荐位';
  if(posidid >0){
