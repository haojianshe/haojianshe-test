...
<!--            <a href="/posid/correct" class="button  button-small  ">改画顶部广告</a>
            <a href="/posid/material" class="button button-small button-primary ">专题顶部广告</a>
            <a href="/posid/index" class="button button-small ">精讲顶部广告</a>-->
     <a href="/posid/material" class="button button-small button-primary ">素材顶部广告</a>
          </div>
        </th></tr>
      <tr class="operate">
...
function addedit(posidid){
	var content = '/posid/edit?channelid=2';
	var title = '添加推荐位';
	if(posidid >0){
