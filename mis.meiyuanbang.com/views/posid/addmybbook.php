...
<script>
    $("#mybbook").change(function(){
       window.location.href = '/posid/addmybbook?uid='+$(this).val()+"&type="+$("#typeid").val();
    });
    ...
    $("#locationid").click(function(){
      setTimeout(function (){
       ...
       window.top.location.replace = '/posid/abilitybook?type='+$("#typeid").val();
    });
    //删除联考活动
