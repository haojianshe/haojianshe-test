 ...
 <form id="cmsform" action="/startpage/thumbupload" method="post" role="form" enctype="multipart/form-data">
 <table>
 	<tbody>
    ...
    <tr>
        ...
        <td>
        	<img src="<? if($model['url']){echo $model['url'];}else echo '/ueditor/dialogs/image/images/image.png'; ?>" style='padding-left:15px;height:200px;' />
        </td>
    </tr>
    <tr>
