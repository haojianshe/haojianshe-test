...
<table cellspacing="0" cellpadding="0" class="content_list">
    <thead>
         <th colspan="12" >
          ...
          <a href="/turntable/prizegame" class="button button-small ">抽奖管理</a>
            <a href="/turntable/index" class="button  button-primary  button-small">奖品列表</a>
          </div>
        </th>
        <tr class="operate">
            <th colspan="2" >
    ...
    <?php foreach ($models as $model) { ?>
        <tr class="tb_list">
            ...
            <td><?php
                ...
                ?></td>
            <?php
           $datas =  TurntableGamePrizesService::getPriceseNnm($model['prizesid']);
                    ?>
            <td><?php echo $datas['prize_num']?></td>
            <td><?php echo $datas['num']?></td>
            <td><?php
                if (@$model['ctime']) {
